...
@click.command()
@click.option('--router-type', required=True, 
...
@click.option('--experiment-name', default='llmrouter-training', help='MLflow experiment name')
@click.option('--output-dir', default='/app/models', help='Output directory for trained model')
